...
- [ ] **Step 1: Replace goal examples with `A9` and `I1`**
...
- [ ] **Step 2: Replace type-wipe coverage with full-elimination coverage**
...
- [ ] **Step 3: Add setup-orientation assertions**
...
- [ ] **Step 4: Run the focused test file and observe the expected failures**
...
- [ ] **Step 1: Set the canonical goals and setup orientation**
...
- [ ] **Step 2: Make winner detection use full elimination**
...
- [ ] **Step 3: Remove the un specified draw/turn-skipping rule**
...
- [ ] **Step 1: Update room/server terminal-state handling**
...
- [ ] **Step 2: Update the browser's goal labels and rendering order**
...
- [ ] **Step 3: Update all local/AI/online terminal checks**
...
- [ ] **Step 2: Run a server smoke check**
...
- [ ] **Step 3: Attempt rendered frontend validation**
...
- [ ] **Step 4: Re-scan the rule matrix**
